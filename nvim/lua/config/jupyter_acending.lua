...
local create_new_cell = function()
	go_to_next_cell()
	api.nvim_command("i<CR># %%<Esc>")
	api.nvim_command("i<CR><Esc>")
	api.nvim_command("i<CR><Esc>")
	api.nvim_command("i<CR><Esc>")
	-- api.nvim_command("o\n\n\n# %%")
...
api.nvim_create_user_command("JupyterPrevCell", go_to_prev_cell, {})
-- api.nvim_create_user_command("JupyterNewCell", create_new_cell, {})
...
-- keymap.set("n", "<Leader>ji", "<cmd>JupyterNewCell<CR>", opts)
